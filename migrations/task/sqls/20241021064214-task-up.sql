...
((select id from "USER" where name = '王小明'),2,14,2520),
((select id from "USER" where name = '王小明'),3,21,4800),
((select id from "USER" where name = '好野人'),2,14,2520);
...
((select id from "COACH" where user_id = (select id from "USER" where name = '李燕容')),(select id from "SKILL" where name = '重訓')),
((select id from "COACH" where user_id = (select id from "USER" where name = '肌肉棒子')),(select id from "SKILL" where name = '重訓')),
((select id from "COACH" where user_id = (select id from "USER" where name = 'Q太郎')),(select id from "SKILL" where name = '重訓')),
...
from "COURSE_BOOKING"
where created_at between '2024-11-01 00:00:00' and '2024-11-30 23:59:59' and status in ('即將授課','上課中');